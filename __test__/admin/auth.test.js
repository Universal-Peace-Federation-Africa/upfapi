...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Pascale57',
        'password':'eb5HOS3hoORSz1M',
        'email':'Kaitlyn_Quitzon92@hotmail.com',
        'honorifics':'Flats',
        'name':'Rene Stark III',
        ...
        'city':'multi-byte',
        'officePhone':'Frozen',
        'pointPerson':'navigate',
        'pointEmail':'Fantastic',
        'facebookID':'Industrial',
        'instagramID':'Borders',
        'twitterID':'withdrawal',
        'linkedInID':'Data',
        'biography':'violet',
        'picture':'Latvian',
        'ambassadorStatus':false,
        'ambassadorCertificate':'driver',
        'appointmentDate':'2024-09-03T17:11:24.920Z',
        'gender':'Transexual Female',
        'birthDate':'2024-05-18T15:32:14.098Z',
        'religion':'Spring',
        'upfPosition':'West',
        'previousPosition':'payment',
        'highestEducation':'Kentucky',
        'associationPosition':'Plastic',
        'leadershipStatus':false,
        'otherTags':'Chair',
        'mobileNo':'(832) 246-6213'
      });
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Kaitlyn_Quitzon92@hotmail.com', });
